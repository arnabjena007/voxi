//! voxi-loadtest: drive N simulated WebSocket clients against a running
//! voxi-server, measure RTT via self-echoed strokes, print a report.
//!
...
//!
//! No assumptions about the server beyond "it implements the voxi wire
